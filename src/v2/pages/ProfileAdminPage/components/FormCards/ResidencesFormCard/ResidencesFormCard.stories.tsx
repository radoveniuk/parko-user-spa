  ...
  args: {
    data: [{
      ...
      accommodation: {
        ...
        name: 'SKH plastic, spol. s r.o.',
        businessName: 'SKH plastic, spol. s r.o.',
        ...
        updatedAt: '2023-09-04T08:47:19.936Z',
      },
      ...
      userWorkTypes: [],
      userStatus: '',
      userCooperationStartDate: undefined,
      userCooperationEndDate: undefined,
      updatedAt: '',
    }],
  },
  render: (args) => (
